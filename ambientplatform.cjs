...
let station=require('./devices/station.cjs')
let tempSensor=require('./devices/temp.cjs')
let aqinSensor=require('./devices/aqin.cjs')
let airSensor=require('./devices/air.cjs')
let leakSensor=require('./devices/leak.cjs')
let motionSensor=require('./devices/motion.cjs')
let occupancySensor=require('./devices/occupancy.cjs')
